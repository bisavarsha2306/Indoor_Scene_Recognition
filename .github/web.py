...
def predict():
    if request.method == "POST":
        if request.form.get("button") == "display":
            # Example values to pass to the display.html page
            value1 = "108_12"
            value2 = "World"
            return redirect(url_for("display", value1="Hello", value2="World"))
        ...
        img_savename = f"static/recognized/recognized{file.filename}.jpg"
        ...
        audio_filename =f"static/recognized/recognized{file.filename}.mp3"
...
def display():
    ...
    return render_template("display.html", value1=value1, value2=value2)
